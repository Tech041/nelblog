      ...
      <Container>
        <div className="relative w-full h-[650px] lg:h-[438px]">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[450px] lg:h-[280px] px-3 md:px-5 bg-black/70 flex items-center justify-center text-white">
            {/* Title */}
            <div className="">
              <p className="text-xl md:text-2xl font-semibold line-clamp-2">
              ...
              <ol className="pl-5 mt-3  ">
                <li className="list-disc  py-1  ">
                  Bride’s Heartwarming Hug With Fola Steals The Show At Wedding
                </li>
                <li className="list-disc py-1  ">
                ...
                <li className="list-disc py-1">
                  Nigerian Actress Seeks UK Asylum, Says Fame Endangers Her Life
                  After End SARS Activism
                </li>
                <li className="list-disc py-1 ">
